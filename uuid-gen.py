...
def generate_uuids(version, count=10, name=None):
    ...
    prefaces = {
        ...
        3: ("UUIDv3 (Name-based UUID using MD5): "
            "Generated by hashing a namespace identifier with a name using MD5. uuid-gen defaults to DNS namespace."),
        4: ("UUIDv4 (Random UUID): "
            "Generated using random numbers."),
        5: ("UUIDv5 (Name-based UUID using SHA-1): "
            "Generated by hashing a namespace identifier with a name using SHA-1. uuid-gen defaults to DNS namespace.")
    }
    ...
    if version in [3, 5] and not name:
        name = input("Please provide a DNS name like 'yourdomain.com' for the name-based UUID: ")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-v', '--version', type=int, choices=[1, 3, 4, 5], default=4, 
                        help="Version of UUID to generate. Options are: "
                             "1 (Time-based), "
                             "3 (DNS Name-based using MD5), "
                             "4 (Random), "
                             "5 (DNS Name-based using SHA-1). Default is 4 (Random).")
    parser.add_argument('-c', '--count', type=int, default=10, 
                        help="Count of UUIDs to generate (default is 10).")
    parser.add_argument('-n', '--name', type=str, default=None, 
                        help="DNS Name for the name-based UUID (used with versions 3 and 5). If not provided, will prompt for input.")
